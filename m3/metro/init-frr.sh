...
# List of metro containers (modify as needed)
metros=(
    "ksa_jed" "ksa_dmm" "ksa_ruh"
    "uae_auh" "uae_shj" "uae_fjr"
    "pak_lhr" "pak_khi" "pak_isb"
    "usa_ny"  "usa_dc"  "usa_ca"
)
...
echo "[🎉] All FRR metro folders initialized"
